...
function HomeOffice() {
  const { homeOffice, setHomeOffice, setFilteredProducts, products, showPopup, setShowPopup, setCart, setPaymentSumm, cartQuantity, setCartQuantity } = useContext(MenuContext);
  ...
  async function fetchHOProducts() {
    try {
      ...
      setHomeOffice(productResponse.data.filter((item) => item.type === "Home and Office"));
    } catch (error) {
    ...
    <div className="overall">
      ...
      <div className="body-content">
        <div className="shopping-categories">
          <div className="home-office-group">Home & Office</div>
          <div className="home-office-list-container js-home-office-container">
            {
              homeOffice.map((item) => {
                return (
                  <div className="home-office-container" key={item.id}>
                    <div className="home-office-img-wishlist">
                      <img className="home-office-img" src={item.image} />
